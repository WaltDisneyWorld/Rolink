"""
    Taken from https://github.com/EvieePy/EvieeBot/blob/2cbf85c98c77776e1f52b4f4f92aa51ddfe4d4ec/utils/paginators.py#L36-L163
    Copyright (c) 2018 EvieePy
    (slightly edited by Tigerism to work with Bloxlink)
"""
